export const advices = [
  ...
  '한번의 실패와 영원한 실패를 혼동하지 마라 -스콧 핏제랄드',
  '내일은 내일의 태양이 뜬다',
  '피할수 없으면 즐겨라 -로버트 엘리엇',
  '절대 어제를 후회하지 마라. 인생은 오늘의 내 안에 있고 내일은 스스로 만드는것이다. -론허바드',
